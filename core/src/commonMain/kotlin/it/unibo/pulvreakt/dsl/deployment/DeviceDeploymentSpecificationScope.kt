 ...
 */
class DeviceDeploymentSpecificationScope(private val deviceName: String) {
    private val componentsStartupHosts = mutableListOf<Pair<Component, Host>>()
...
//        }
     ...
     */
    fun reconfigurationRules(@Suppress("UNUSED_PARAMETER") config: ReconfigurationRulesScope.() -> Unit) {
