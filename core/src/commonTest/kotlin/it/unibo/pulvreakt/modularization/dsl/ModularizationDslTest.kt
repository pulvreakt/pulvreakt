...
class ModularizationDslTest : StringSpec({
    "The modularization DSL should allows to bind two modules" {
    ...
    "The modularization DSL should allows to bind multiple modules as input of another module" {
    ...
    "The modularization DSL should allows to bind a module as input of multiple modules" {
    ...
    "The modularization DSL should allows to bind multiple modules as input of multiple modules" {
