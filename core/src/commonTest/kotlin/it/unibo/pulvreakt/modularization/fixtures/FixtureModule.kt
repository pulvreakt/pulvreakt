...
import it.unibo.pulvreakt.modularization.api.module.AbstractModule
import it.unibo.pulvreakt.modularization.api.module.ModuleResult
import org.kodein.di.instance
import kotlin.math.sqrt

class SqrtModule : AbstractModule<Nothing, Double, Double>() {
    override val capabilities = null

    override fun buildInput(): ModuleResult<Double> = 12.0.right()
...
class SumModule : AbstractModule<Nothing, Double, Double>() {
    ...
    override fun buildInput(): ModuleResult<Double> = 10.0.right()
...
class SensorModule : AbstractModule<EmbeddedSensor, Unit, Double>() {
    ...
    override fun buildInput(): ModuleResult<Unit> = Unit.right()
...
class SelectionModule : AbstractModule<UnionCapabilities, Unit, Double>() {
    ...
    override fun invoke(input: Unit): Double =
        when (capabilities) {
