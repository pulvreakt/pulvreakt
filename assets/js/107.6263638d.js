...
/* harmony export */ });
/* harmony import */ var _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(94259);
...
/* harmony import */ var _setupGraphViewbox_e35e4124_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(48003);
...
const sanitizeText = (txt) => _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.d.sanitizeText(txt, (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)());
let conf = {
  dividerMargin: 10,
  padding: 5,
  textHeight: 10,
...
const addClasses = function(classes, g, _id, diagObj) {
  ...
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("keys:", keys);
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info(classes);
  keys.forEach(function(id) {
    ...
    const node = {
      ...
      padding: ((_a = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().flowchart) == null ? void 0 : _a.padding) ?? ((_b = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().class) == null ? void 0 : _b.padding)
    };
    g.setNode(vertex.id, node);
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("setNode", node);
  });
};
const addNotes = function(notes, g, startEdgeId, classes) {
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info(notes);
  notes.forEach(function(note, i) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_8__.n)(conf.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    g.setEdge(vertex.id, vertex.class, edgeData, edgeId);
  });
};
const addRelations = function(relations, g) {
  const conf2 = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().flowchart;
  let cnt = 0;
  relations.forEach(function(edge) {
    ...
    const edgeData = {
      ...
      style: "fill:none",
      labelStyle: "",
      curve: (0,_utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_8__.n)(conf2 == null ? void 0 : conf2.curve, d3__WEBPACK_IMPORTED_MODULE_0__/* .curveLinear */ .c_6)
    };
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info(edgeData, edge);
    if (edge.style !== void 0) {
      const styles2 = (0,_utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_8__.m)(edge.style);
    ...
    if (edge.text === void 0) {
      ...
      edgeData.arrowheadStyle = "fill: #333";
      edgeData.labelpos = "c";
      if (((_a = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().flowchart) == null ? void 0 : _a.htmlLabels) ?? (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().htmlLabels) {
        edgeData.labelType = "html";
        edgeData.label = '<span class="edgeLabel">' + edge.text + "</span>";
      } else {
        edgeData.labelType = "text";
        edgeData.label = edge.text.replace(_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.d.lineBreakRegex, "\n");
        if (edge.style === void 0) {
...
const draw = function(text, id, _version, diagObj) {
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing class - ", id);
  const conf2 = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().flowchart ?? (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().class;
  const securityLevel = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().securityLevel;
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("config:", conf2);
  ...
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info(relations);
  ...
  (0,_index_f9d09cc9_js__WEBPACK_IMPORTED_MODULE_9__.r)(
    element,
    g,
  ...
  _utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_8__.u.insertTitle(svg, "classTitleText", (conf2 == null ? void 0 : conf2.titleTopMargin) ?? 5, diagObj.db.getDiagramTitle());
  (0,_setupGraphViewbox_e35e4124_js__WEBPACK_IMPORTED_MODULE_10__.s)(g, svg, conf2 == null ? void 0 : conf2.diagramPadding, conf2 == null ? void 0 : conf2.useMaxWidth);
...
const diagram = {
  parser: _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_11__.p,
  db: _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_11__.d,
  renderer,
  styles: _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_11__.s,
  init: (cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_11__.d.clear();
  }
};
...
let classCounter = 0;
let functions = [];
const sanitizeText = (txt) => _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_1__.d.sanitizeText(txt, (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_1__.g)());
...
const addRelation = function(relation) {
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_1__.l.debug("Adding relation: " + JSON.stringify(relation));
  addClass(relation.id1);
  addClass(relation.id2);
  relation.id1 = splitClassNameAndType(relation.id1).className;
  relation.id2 = splitClassNameAndType(relation.id2).className;
  relation.relationTitle1 = _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_1__.d.sanitizeText(
    relation.relationTitle1.trim(),
    (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_1__.g)()
  );
  relation.relationTitle2 = _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_1__.d.sanitizeText(
...
const setLink = function(ids, linkStr, target) {
  const config = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_1__.g)();
  ids.split(",").forEach(function(_id) {
    let id = _id;
    if (_id[0].match(/\d/)) {
      id = MERMAID_DOM_ID_PREFIX + id;
    ...
    if (classes[id] !== void 0) {
      classes[id].link = _utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_4__.u.formatUrl(linkStr, config);
    ...
    functions.push(function() {
      ...
      if (elem !== null) {
        elem.addEventListener(
          "click",
          function() {
            _utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_4__.u.runFunc(functionName, ...argList);
          },
          false
        );
      }
...
const db = {
  ...
  getConfig: () => (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_1__.g)().class,
  addClass,
  bindFunctions,
  clear,
  getClass,
