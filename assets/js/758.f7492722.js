...
/* harmony export */ });
/* harmony import */ var _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(94259);
...
/* harmony import */ var _svgDraw_6a237a99_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(4376);
...
const draw = function(text, id, _version, diagObj) {
  const conf = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_6__.g)().class;
  idCache = {};
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Rendering diagram " + text);
  ...
  for (const key of keys) {
    ...
    const node = _svgDraw_6a237a99_js__WEBPACK_IMPORTED_MODULE_7__.s.drawClass(diagram2, classDef, conf, diagObj);
    idCache[node.id] = node;
    g.setNode(node.id, node);
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_6__.l.info("Org height: " + node.height);
  }
  const relations = diagObj.db.getRelations();
  relations.forEach(function(relation) {
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_6__.l.info(
  ...
  notes.forEach(function(note) {
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(`Adding note: ${JSON.stringify(note)}`);
    const node = _svgDraw_6a237a99_js__WEBPACK_IMPORTED_MODULE_7__.s.drawNote(diagram2, note, conf, diagObj);
    idCache[node.id] = node;
    g.setNode(node.id, node);
  ...
  g.nodes().forEach(function(v) {
    if (v !== void 0 && g.node(v) !== void 0) {
      _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Node " + v + ": " + JSON.stringify(g.node(v)));
  ...
  g.edges().forEach(function(e) {
    if (e !== void 0 && g.edge(e) !== void 0) {
      _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Edge " + e.v + " -> " + e.w + ": " + JSON.stringify(g.edge(e)));
      _svgDraw_6a237a99_js__WEBPACK_IMPORTED_MODULE_7__.s.drawEdge(diagram2, g.edge(e), g.edge(e).relation, conf, diagObj);
    }
  });
  ...
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_6__.l.debug(`viewBox ${vBox}`);
...
const diagram = {
  parser: _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_9__.p,
  db: _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_9__.d,
  renderer,
  styles: _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_9__.s,
  init: (cnf) => {
    if (!cnf.class) {
      cnf.class = {};
    }
    cnf.class.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_0dd3ba1e_js__WEBPACK_IMPORTED_MODULE_9__.d.clear();
  }
};
