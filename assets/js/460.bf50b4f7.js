...
/* harmony export */ });
/* harmony import */ var _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(1213);
...
/* harmony import */ var _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(9419);
/* harmony import */ var _index_f9d09cc9_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(73841);
/* harmony import */ var _setupGraphViewbox_e35e4124_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(48003);
/* harmony import */ var _utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(85408);
...
/* harmony import */ var _braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(17967);
...
const getClasses = function(text, diagramObj) {
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.trace("Extracting classes");
  diagramObj.db.clear();
  try {
...
const setupNode = (g, parent, parsedItem, diagramStates, diagramDb, altFlag) => {
  ...
  if (itemId !== "root") {
    ...
    if (parsedItem.type !== _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.a) {
    ...
    if (!nodeDb[itemId]) {
      nodeDb[itemId] = {
        id: itemId,
        shape,
        description: _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.d.sanitizeText(itemId, (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)()),
    ...
    if (parsedItem.description) {
      ...
      newNode.description = _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.d.sanitizeTextOrArray(newNode.description, (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)());
    }
    if (newNode.description.length === 1 && newNode.shape === SHAPE_STATE_WITH_DESC) {
      newNode.shape = SHAPE_STATE;
    }
    if (!newNode.type && parsedItem.doc) {
      _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Setting cluster for ", itemId, getDir(parsedItem));
      newNode.type = "group";
      newNode.dir = getDir(parsedItem);
      newNode.shape = parsedItem.type === _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.b ? SHAPE_DIVIDER : SHAPE_GROUP;
  ...
  if (parent && parent.id !== "root") {
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.trace("Setting node ", itemId, " to be child of its parent ", parent.id);
    g.setParent(itemId, parent.id);
  }
  if (parsedItem.doc) {
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.trace("Adding nodes children ");
    setupDoc(g, parsedItem, parsedItem.doc, diagramStates, diagramDb, !altFlag);
  }
};
const setupDoc = (g, parentParsedItem, doc, diagramStates, diagramDb, altFlag) => {
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.trace("items", doc);
  doc.forEach((item) => {
    switch (item.stmt) {
      case _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.c:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.a:
        setupNode(g, parentParsedItem, item, diagramStates, diagramDb, altFlag);
        break;
      case _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.S:
        {
          ...
          const edgeData = {
            ...
            style: G_EDGE_STYLE,
            labelStyle: "",
            label: _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.d.sanitizeText(item.description, (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)()),
            arrowheadStyle: G_EDGE_ARROWHEADSTYLE,
            labelpos: G_EDGE_LABELPOS,
            labelType: G_EDGE_LABELTYPE,
            thickness: G_EDGE_THICKNESS,
...
const getDir = (parsedItem, defaultDir = _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.e) => {
  let dir = defaultDir;
  if (parsedItem.doc) {
...
const draw = function(text, id, _version, diag) {
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Drawing state diagram (v2)", id);
  nodeDb = {};
  let dir = diag.db.getDirection();
  if (dir === void 0) {
    dir = _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.D;
  }
  const { securityLevel, state: conf } = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)();
  const nodeSpacing = conf.nodeSpacing || 50;
  const rankSpacing = conf.rankSpacing || 50;
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info(diag.db.getRootDocV2());
  ...
  (0,_index_f9d09cc9_js__WEBPACK_IMPORTED_MODULE_9__.r)(element, g, ["barb"], CSS_DIAGRAM, id);
  const padding = 8;
  _utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_10__.u.insertTitle(svg, "statediagramTitleText", conf.titleTopMargin, diag.db.getDiagramTitle());
  const bounds = svg.node().getBBox();
  const width = bounds.width + padding * 2;
  const height = bounds.height + padding * 2;
  svg.attr("class", CSS_DIAGRAM);
  const svgBounds = svg.node().getBBox();
  (0,_setupGraphViewbox_e35e4124_js__WEBPACK_IMPORTED_MODULE_11__.c)(svg, height, width, conf.useMaxWidth);
  const vBox = `${svgBounds.x - padding} ${svgBounds.y - padding} ${width} ${height}`;
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.debug(`viewBox ${vBox}`);
...
const diagram = {
  parser: _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.p,
  db: _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.d,
  renderer,
  styles: _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.s,
  init: (cnf) => {
    if (!cnf.state) {
      cnf.state = {};
    }
    cnf.state.arrowMarkerAbsolute = cnf.arrowMarkerAbsolute;
    _styles_d6bd7a5e_js__WEBPACK_IMPORTED_MODULE_8__.d.clear();
  }
};
