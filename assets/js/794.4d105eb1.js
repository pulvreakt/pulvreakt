...
const addElement = (name) => {
  if (elements[name] === void 0) {
    ...
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new requirement: ", name);
  }
  latestElement = {};
...
const db = {
  ...
  Relationships,
  parseDirective,
  getConfig: () => (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().req,
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr(
      "marker-start",
      "url(" + _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.d.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)"
    );
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr(
      "marker-end",
      "url(" + _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.d.getUrl(conf.arrowMarkerAbsolute) + "#" + markers.ReqMarkers.ARROW + "_line_ending)"
    );
  }
...
const drawReqs = (reqs, graph, svgNode) => {
  Object.keys(reqs).forEach((reqName) => {
    ...
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new requirement: ", reqName);
...
const draw = (text, id, _version, diagObj) => {
  conf = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_7__.g)().requirement;
  diagObj.db.clear();
  ...
  (0,_setupGraphViewbox_e35e4124_js__WEBPACK_IMPORTED_MODULE_9__.c)(svg, height, width, conf.useMaxWidth);
...
//# sourceMappingURL=requirementDiagram-84e9ae78.js.map
