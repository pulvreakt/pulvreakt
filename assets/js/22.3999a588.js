...
/* harmony export */ });
/* harmony import */ var _mermaidAPI_a1a81019_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(44724);
/* harmony import */ var _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(51896);
/* harmony import */ var _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(58553);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(94646);
/* harmony import */ var _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(53622);
...
/* harmony import */ var moment_mini__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(11941);
...
const parseDirective = function(statement, context, type) {
  _mermaidAPI_a1a81019_js__WEBPACK_IMPORTED_MODULE_4__.m.parseDirective(this, statement, context, type);
};
...
const autoWrap = () => {
  ...
  return (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)().sequence.wrap;
};
const clear = function() {
  ...
  messages = [];
  sequenceNumbersEnabled = false;
  (0,_commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_6__.f)();
};
const parseMessage = function(str) {
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("parseMessage:", message);
  return message;
};
const parseBoxData = function(str) {
  ...
  const boxData = {
    color,
    text: title !== void 0 ? (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.b)(title.replace(/^:?(?:no)?wrap:/, ""), (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)()) : void 0,
...
const addLinks = function(actorId, text) {
  ...
  try {
    let sanitizedText = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.b)(text.text, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)());
    sanitizedText = sanitizedText.replace(/&amp;/g, "&");
    sanitizedText = sanitizedText.replace(/&equals;/g, "=");
    const links = JSON.parse(sanitizedText);
    insertLinks(actor, links);
  } catch (e) {
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.error("error while parsing actor link text", e);
  }
};
...
const addProperties = function(actorId, text) {
  ...
  try {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.error("error while parsing actor properties text", e);
  }
};
...
const addDetails = function(actorId, text) {
  ...
  try {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.error("error while parsing actor details text", e);
  }
};
  ...
  if (Array.isArray(param)) {
    ...
    switch (param.type) {
      ...
      case "altEnd":
        ...
        break;
      case "setAccTitle":
        (0,_commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_6__.s)(param.text);
        break;
      case "parStart":
...
const db = {
  ...
  getActorKeys,
  getActorProperty,
  getAccTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_6__.g,
  getBoxes,
  getDiagramTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_6__.e,
  setDiagramTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_6__.d,
  parseDirective,
  getConfig: () => (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)().sequence,
  clear,
  parseMessage,
  parseBoxData,
  LINETYPE,
  ...
  PLACEMENT,
  addNote,
  setAccTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_6__.s,
  apply,
  setAccDescription: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_6__.b,
  getAccDescription: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_6__.a,
  hasAtLeastOneBox,
...
const addPopupInteraction = (id, actorCnt2) => {
  (0,_mermaidAPI_a1a81019_js__WEBPACK_IMPORTED_MODULE_4__.a)(() => {
...
const drawText = function(elem, textData) {
  ...
  const lines = textData.text.split(_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.d.lineBreakRegex);
  const [_textFontSize, _textFontSizePx] = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.t)(textData.fontSize);
  let textElems = [];
  let dy = 0;
...
const _drawTextCandidateFunc = function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const [_actorFontSize, _actorFontSizePx] = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.t)(actorFontSize);
    const lines = content.split(_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.d.lineBreakRegex);
...
const bounds = {
  ...
  init: function() {
    ...
    this.verticalPos = 0;
    setConf((0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)());
  },
...
function boundMessage(_diagram, msgModel) {
  ...
  const lines = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.d.splitBreaks(message).length;
  const textDims = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.calculateTextDimensions(message, messageFont(conf));
...
const setConf = function(cnf) {
  (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.c)(conf, cnf);
  if (cnf.fontFamily) {
...
function adjustLoopHeightForWrap(loopWidths, msg, preMargin, postMargin, addLoopFn) {
  ...
  if (msg.id && msg.message && loopWidths[msg.id]) {
    ...
    msg.message = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.wrapLabel(`[${msg.message}]`, loopWidth - 2 * conf.wrapPadding, textConf);
    msg.width = loopWidth;
    msg.wrap = true;
    const textDims = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.calculateTextDimensions(msg.message, textConf);
    const totalOffset = Math.max(textDims.height, conf.labelBoxHeight);
    heightAdjust = postMargin + totalOffset;
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug(`${totalOffset} - ${msg.message}`);
  }
  addLoopFn(msg);
  bounds.bumpVerticalPos(heightAdjust);
}
const draw = function(_text, id, _version, diagObj) {
  const { securityLevel, sequence } = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)();
  conf = sequence;
  diagObj.db.clear();
  ...
  bounds.init();
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug(diagObj.db);
    ...
    switch (msg.type) {
      ...
      default:
        try {
          ...
          _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.error("error while drawing message", e);
        }
    }
    if ([
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("For line height fix Querying: #" + id + " .actor-line");
  ...
  (0,_setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_8__.c)(diagram2, height, width, conf.useMaxWidth);
  const extraVertForTitle = title ? 40 : 0;
  diagram2.attr(
    "viewBox",
    box.startx - conf.diagramMarginX + " -" + (conf.diagramMarginY + extraVertForTitle) + " " + width + " " + (height + extraVertForTitle)
  );
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug(`models:`, bounds.models);
};
function getMaxMessageWidthPerActor(actors2, messages2, diagObj) {
  ...
  messages2.forEach(function(msg) {
    if (actors2[msg.to] && actors2[msg.from]) {
      ...
      const wrappedMessage = msg.wrap ? _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.wrapLabel(msg.message, conf.width - 2 * conf.wrapPadding, textFont) : msg.message;
      const messageDimensions = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.calculateTextDimensions(wrappedMessage, textFont);
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("maxMessageWidthPerActor:", maxMessageWidthPerActor);
...
const getRequiredPopupWidth = function(actor) {
  ...
  for (const key in actor.links) {
    const labelDimensions = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.calculateTextDimensions(key, textFont);
...
function calculateActorMargins(actors2, actorToMessageWidth, boxes2) {
  ...
  Object.keys(actors2).forEach((prop) => {
    ...
    if (actor.wrap) {
      actor.description = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.wrapLabel(
        actor.description,
        conf.width - 2 * conf.wrapPadding,
        actorFont(conf)
      );
    }
    const actDims = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.calculateTextDimensions(actor.description, actorFont(conf));
  ...
  boxes2.forEach((box) => {
    ...
    if (box.wrap) {
      box.name = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.wrapLabel(box.name, totalWidth - 2 * conf.wrapPadding, textFont);
    }
    const boxMsgDimensions = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.calculateTextDimensions(box.name, textFont);
...
const buildNoteModel = function(msg, actors2, diagObj) {
  ...
  let textDimensions = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.calculateTextDimensions(
    shouldWrap ? _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.wrapLabel(msg.message, conf.width, noteFont(conf)) : msg.message,
    noteFont(conf)
  );
  const noteModel = {
  ...
  if (msg.placement === diagObj.db.PLACEMENT.RIGHTOF) {
    ...
    textDimensions = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.calculateTextDimensions(
      shouldWrap ? _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.wrapLabel(msg.message, Math.max(conf.width, actors2[msg.from].width), noteFont(conf)) : msg.message,
      noteFont(conf)
    );
  ...
  if (shouldWrap) {
    noteModel.message = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.wrapLabel(
      msg.message,
      noteModel.width - 2 * conf.wrapPadding,
      noteFont(conf)
    );
  }
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug(
...
const buildMessageModel = function(msg, actors2, diagObj) {
  ...
  if (msg.wrap && msg.message) {
    msg.message = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.wrapLabel(
      msg.message,
      Math.max(boundedWidth + 2 * conf.wrapPadding, conf.width),
      messageFont(conf)
    );
  }
  const msgDims = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.calculateTextDimensions(msg.message, messageFont(conf));
  return {
    width: Math.max(
...
const calculateLoopBounds = function(messages2, actors2, _maxWidthPerActor, diagObj) {
  ...
  messages2.forEach(function(msg) {
    msg.id = _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.random({ length: 10 });
    switch (msg.type) {
      case diagObj.db.LINETYPE.LOOP_START:
      case diagObj.db.LINETYPE.ALT_START:
      case diagObj.db.LINETYPE.OPT_START:
  ...
  bounds.activations = [];
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Loop type widths:", loops);
  return loops;
};
const renderer = {
  bounds,
