...
/* harmony export */ });
/* harmony import */ var moment_mini__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11941);
...
/* harmony import */ var _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(58553);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(94646);
...
const clear = function() {
  ...
  lastOrder = 0;
  links = {};
  (0,_commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_5__.f)();
};
...
const checkTaskDates = function(task, dateFormat2, excludes2, includes2) {
  ...
  let startTime = moment_mini__WEBPACK_IMPORTED_MODULE_0__(task.startTime, dateFormat2, true);
  startTime.add(1, "d");
  let endTime = moment_mini__WEBPACK_IMPORTED_MODULE_0__(task.endTime, dateFormat2, true);
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  let mDate = moment_mini__WEBPACK_IMPORTED_MODULE_0__(str, dateFormat2.trim(), true);
  if (mDate.isValid()) {
    return mDate.toDate();
  } else {
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Invalid date:" + str);
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("With date format:" + dateFormat2.trim());
...
const parseDuration = function(str) {
  ...
  if (statement !== null) {
    return moment_mini__WEBPACK_IMPORTED_MODULE_0__.duration(Number.parseFloat(statement[1]), statement[2]);
  }
  return moment_mini__WEBPACK_IMPORTED_MODULE_0__.duration.invalid();
};
const getEndDate = function(prevTime, dateFormat2, str, inclusive = false) {
  ...
  const endTime = moment_mini__WEBPACK_IMPORTED_MODULE_0__(prevTime);
...
const compileData = function(prevTask, dataStr) {
  ...
  if (endTimeData) {
    ...
    task.manualEndTime = moment_mini__WEBPACK_IMPORTED_MODULE_0__(endTimeData, "YYYY-MM-DD", true).isValid();
  ...
  const compileTask = function(pos) {
    ...
    if (rawTasks[pos].startTime) {
      ...
      if (rawTasks[pos].endTime) {
        ...
        rawTasks[pos].manualEndTime = moment_mini__WEBPACK_IMPORTED_MODULE_0__(
          rawTasks[pos].raw.endTime.data,
          "YYYY-MM-DD",
          true
        ).isValid();
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.g)().securityLevel !== "loose") {
    linkStr = (0,_braintree_sanitize_url__WEBPACK_IMPORTED_MODULE_1__/* .sanitizeUrl */ .N)(_linkStr);
  }
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  parseDirective,
  getConfig: () => (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.g)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
  ...
  setTodayMarker,
  getTodayMarker,
  setAccTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_5__.s,
  getAccTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_5__.g,
  setDiagramTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_5__.d,
  getDiagramTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_5__.e,
  setAccDescription: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_5__.b,
  getAccDescription: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_5__.a,
  addSection,
  getSections,
  getTasks,
  addTask,
...
const setConf = function() {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("Something is calling, setConf, remove the call");
};
let w;
const draw = function(text, id, version, diagObj) {
  const conf = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.g)().gantt;
  ...
  const timeScale = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .scaleTime */ .Xf)().domain([
    (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .min */ .VV$)(taskArray, function(d) {
      return d.startTime;
    }),
    (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .max */ .Fp7)(taskArray, function(d) {
      return d.endTime;
    })
  ...
  (0,_setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_8__.c)(svg, h, w, conf.useMaxWidth);
  ...
  function makeGant(tasks2, pageWidth, pageHeight) {
    ...
    const colorScale = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .scaleLinear */ .BYU)().domain([0, categories.length]).range(["#00B9FA", "#F95002"]).interpolate(d3__WEBPACK_IMPORTED_MODULE_2__/* .interpolateHcl */ .JHv);
    drawExcludeDays(
      gap,
      topPadding,
      leftPadding,
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.g)().securityLevel;
    if (securityLevel2 === "sandbox") {
      let sandboxElement2;
      sandboxElement2 = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .select */ .Ys)("#i" + id);
  ...
  function drawExcludeDays(theGap, theTopPad, theSidePad, w2, h2, tasks2, excludes2, includes2) {
    ...
    const excludeRanges = [];
    let range = null;
    let d = moment_mini__WEBPACK_IMPORTED_MODULE_0__(minTime);
  ...
  function makeGrid(theSidePad, theTopPad, w2, h2) {
    let bottomXAxis = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .axisBottom */ .LLu)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0,d3__WEBPACK_IMPORTED_MODULE_2__/* .timeFormat */ .i$Z)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
    ...
    if (resultTickInterval !== null) {
      ...
      switch (interval) {
        case "minute":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeMinute.every */ .Z_i.every(every));
          break;
        case "hour":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeHour.every */ .WQD.every(every));
          break;
        case "day":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeDay.every */ .rr1.every(every));
          break;
        case "week":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeWeek.every */ .NGh.every(every));
          break;
        case "month":
          bottomXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeMonth.every */ .F0B.every(every));
          break;
      }
    }
    svg.append("g").attr("class", "grid").attr("transform", "translate(" + theSidePad + ", " + (h2 - 50) + ")").call(bottomXAxis).selectAll("text").style("text-anchor", "middle").attr("fill", "#000").attr("stroke", "none").attr("font-size", 10).attr("dy", "1em");
    if (diagObj.db.topAxisEnabled() || conf.topAxis) {
      let topXAxis = (0,d3__WEBPACK_IMPORTED_MODULE_2__/* .axisTop */ .F5q)(timeScale).tickSize(-h2 + theTopPad + conf.gridLineStartPadding).tickFormat((0,d3__WEBPACK_IMPORTED_MODULE_2__/* .timeFormat */ .i$Z)(diagObj.db.getAxisFormat() || conf.axisFormat || "%Y-%m-%d"));
      if (resultTickInterval !== null) {
        const every = resultTickInterval[1];
        const interval = resultTickInterval[2];
        switch (interval) {
          case "minute":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeMinute.every */ .Z_i.every(every));
            break;
          case "hour":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeHour.every */ .WQD.every(every));
            break;
          case "day":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeDay.every */ .rr1.every(every));
            break;
          case "week":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeWeek.every */ .NGh.every(every));
            break;
          case "month":
            topXAxis.ticks(d3__WEBPACK_IMPORTED_MODULE_2__/* .timeMonth.every */ .F0B.every(every));
            break;
        }
      }
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurances).enter().append(function(d) {
      const rows = d[0].split(_config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.d.lineBreakRegex);
...
//# sourceMappingURL=ganttDiagram-18b8bb1d.js.map
