...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/mermaidAPI-a1a81019.js + 5 modules
var mermaidAPI_a1a81019 = __webpack_require__(44724);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/commonDb-7528607a.js
var commonDb_7528607a = __webpack_require__(58553);
// EXTERNAL MODULE: ./node_modules/dagre-d3-es/src/graphlib/index.js
var graphlib = __webpack_require__(45625);
...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/erDiagram-508b3995.js
...
const parseDirective = function(statement, context, type) {
  mermaidAPI_a1a81019.m.parseDirective(this, statement, context, type);
};
const addEntity = function(name) {
  if (entities[name] === void 0) {
    entities[name] = { attributes: [] };
    config_5161385b.l.info("Added new entity :", name);
  }
...
const addAttributes = function(entityName, attribs) {
  ...
  for (i = attribs.length - 1; i >= 0; i--) {
    ...
    config_5161385b.l.debug("Added attribute ", attribs[i].attributeName);
  }
};
const addRelationship = function(entA, rolA, entB, rSpec) {
  ...
  config_5161385b.l.debug("Added new relationship :", rel);
};
const getRelationships = () => relationships;
const clear = function() {
  entities = {};
  relationships = [];
  (0,commonDb_7528607a.f)();
};
const erDb = {
  Cardinality,
  Identification,
  parseDirective,
  getConfig: () => (0,config_5161385b.g)().er,
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
  getRelationships,
  clear,
  setAccTitle: commonDb_7528607a.s,
  getAccTitle: commonDb_7528607a.g,
  setAccDescription: commonDb_7528607a.b,
  getAccDescription: commonDb_7528607a.a,
  setDiagramTitle: commonDb_7528607a.d,
  getDiagramTitle: commonDb_7528607a.e
};
const ERMarkers = {
...
const drawAttributes = (groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,config_5161385b.p)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,config_5161385b.g)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,config_5161385b.g)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,config_5161385b.g)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
    ...
    if (hasComment) {
      const commentNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,config_5161385b.g)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeComment || "");
...
const drawEntities = function(svgNode, entities2, graph) {
  ...
  keys.forEach(function(entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", (0,config_5161385b.g)().fontFamily).style("font-size", conf.fontSize + "px").text(entityName);
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  const labelNode = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", (0,config_5161385b.g)().fontFamily).style("font-size", conf.fontSize + "px").text(rel.roleA);
...
const draw = function(text, id, _version, diagObj) {
  conf = (0,config_5161385b.g)().er;
  config_5161385b.l.info("Drawing ER diagram");
  const securityLevel = (0,config_5161385b.g)().securityLevel;
  let sandboxElement;
  ...
  utils_3cbdbddf.u.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
  const svgBounds = svg.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,setupGraphViewbox_e1099da8.c)(svg, height, width, conf.useMaxWidth);
...
//# sourceMappingURL=erDiagram-508b3995.js.map
