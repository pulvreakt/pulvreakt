...
const setMessage = (txt) => {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Setting message to: " + txt);
  message = txt;
};
const getMessage = () => {
  return message;
...
const db = {
  ...
  setInfo,
  getInfo,
  clear: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_4__.f
  // parseError
};
const getStyles = () => ``;
...
const draw = (text, id, version) => {
  try {
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Rendering info diagram\n" + text);
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.error("Error while rendering info diagram");
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.error(e.message);
  }
};
const renderer = {
  draw
...
//# sourceMappingURL=infoDiagram-cc60b1ac.js.map
