...
const tasks = [];
const rawTasks = [];
const getCommonDb = () => _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_4__.c;
const parseDirective = (statement, context, type) => {
  (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_5__.p)(globalThis, statement, context, type);
};
...
const draw = function(text, id, version, diagObj) {
  const conf2 = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.g)();
  const LEFT_MARGIN = conf2.leftMargin ? conf2.leftMargin : 50;
  diagObj.db.clear();
  diagObj.parser.parse(text + "\n");
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("timeline", diagObj.db);
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("task", tasks2);
  svgDraw.initGraphics(svg);
  const sections2 = diagObj.db.getSections();
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("sections", sections2);
  ...
  sections2.forEach(function(section) {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("sectionHeight before draw", sectionHeight);
    maxSectionHeight = Math.max(maxSectionHeight, sectionHeight + 20);
  });
  let maxEventCount = 0;
  let maxEventLineLength = 0;
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("tasks.length", tasks2.length);
  for (const [i, task] of tasks2.entries()) {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("taskHeight before draw", taskHeight);
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("maxSectionHeight before draw", maxSectionHeight);
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("maxTaskHeight before draw", maxTaskHeight);
  if (sections2 && sections2.length > 0) {
    sections2.forEach((section) => {
      ...
      _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("sectionNode", sectionNode);
      const sectionNodeWrapper = svg.append("g");
      const node = svgDraw.drawNode(sectionNodeWrapper, sectionNode, sectionNumber, conf2);
      _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("sectionNode output", node);
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("bounds", box);
  if (title) {
  ...
  (0,_setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_7__.s)(
    void 0,
    svg,
...
const drawTasks = function(diagram2, tasks2, sectionColor, masterX, masterY, maxTaskHeight, conf2, maxEventCount, maxEventLineLength, maxSectionHeight, isWithoutSections) {
  for (const task of tasks2) {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("taskNode", taskNode);
    const taskWrapper = diagram2.append("g").attr("class", "taskWrapper");
    const node = svgDraw.drawNode(taskWrapper, taskNode, sectionColor, conf2);
    const taskHeight = node.height;
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("taskHeight after draw", taskHeight);
    ...
    masterX = masterX + 200;
    if (isWithoutSections && !(0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.g)().timeline.disableMulticolor) {
      sectionColor++;
    }
  }
  masterY = masterY - 10;
...
const drawEvents = function(diagram2, events, sectionColor, masterX, masterY, conf2) {
  ...
  for (const event of events) {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_6__.l.debug("eventNode", eventNode);
...
//# sourceMappingURL=timeline-definition-bc3d9443.js.map
