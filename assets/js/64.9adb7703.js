...
/* harmony import */ var _mermaidAPI_0716c7c2_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(90236);
/* harmony import */ var _commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(40317);
/* harmony import */ var d3__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(94646);
...
const parseDirective = function(statement, context, type) {
  _mermaidAPI_0716c7c2_js__WEBPACK_IMPORTED_MODULE_7__.m.parseDirective(this, statement, context, type);
};
const clear = function() {
  ...
  lastOrder = 0;
  links = {};
  (0,_commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_8__.f)();
};
...
const getStartDate = function(prevTime, dateFormat2, str) {
  ...
  if (mDate.isValid()) {
    ...
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_9__.l.debug("Invalid date:" + str);
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_9__.l.debug("With date format:" + dateFormat2.trim());
...
const setLink = function(ids, _linkStr) {
  ...
  if ((0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_9__.g)().securityLevel !== "loose") {
...
const setClickFun = function(id, functionName, functionArgs) {
  ...
  if (rawTask !== void 0) {
    pushFun(id, () => {
      _utils_d5eeff82_js__WEBPACK_IMPORTED_MODULE_10__.u.runFunc(functionName, ...argList);
    });
  }
};
...
const ganttDb = {
  parseDirective,
  getConfig: () => (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_9__.g)().gantt,
  clear,
  setDateFormat,
  getDateFormat,
  ...
  setTodayMarker,
  getTodayMarker,
  setAccTitle: _commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_8__.s,
  getAccTitle: _commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_8__.g,
  setDiagramTitle: _commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_8__.d,
  getDiagramTitle: _commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_8__.e,
  setAccDescription: _commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_8__.b,
  getAccDescription: _commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_8__.a,
  addSection,
  getSections,
  getTasks,
  addTask,
...
const setConf = function() {
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_9__.l.debug("Something is calling, setConf, remove the call");
};
let w;
const draw = function(text, id, version, diagObj) {
  const conf = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_9__.g)().gantt;
  const securityLevel = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_9__.g)().securityLevel;
  let sandboxElement;
  ...
  (0,_setupGraphViewbox_e35e4124_js__WEBPACK_IMPORTED_MODULE_11__.c)(svg, h, w, conf.useMaxWidth);
  ...
  function drawRects(theArray, theGap, theTopPad, theSidePad, theBarHeight, theColorScale, w2) {
    ...
    const securityLevel2 = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_9__.g)().securityLevel;
  ...
  function vertLabels(theGap, theTopPad) {
    ...
    svg.append("g").selectAll("text").data(numOccurances).enter().append(function(d) {
      const rows = d[0].split(_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_9__.d.lineBreakRegex);
