...
const setMessage = (txt) => {
  _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Setting message to: " + txt);
  message = txt;
};
const getMessage = () => {
  return message;
...
const db = {
  ...
  setInfo,
  getInfo,
  clear: _commonDb_2ace122b_js__WEBPACK_IMPORTED_MODULE_4__.f
  // parseError
};
const getStyles = () => ``;
...
const draw = (text, id, version) => {
  try {
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Rendering info diagram\n" + text);
    const securityLevel = (0,_config_389b86ff_js__WEBPACK_IMPORTED_MODULE_3__.g)().securityLevel;
    let sandboxElement;
    ...
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_3__.l.error("Error while rendering info diagram");
    _config_389b86ff_js__WEBPACK_IMPORTED_MODULE_3__.l.error(e.message);
  }
};
const renderer = {
  draw
