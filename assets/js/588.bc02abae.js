...
/* harmony export */ });
/* harmony import */ var _config_5161385b_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(51896);
/* harmony import */ var _mermaidAPI_a1a81019_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(44724);
/* harmony import */ var _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(58553);
...
const addElement = (name) => {
  if (elements[name] === void 0) {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new requirement: ", name);
  }
  latestElement = {};
...
const clear = () => {
  ...
  latestElement = {};
  elements = {};
  (0,_commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_8__.f)();
};
const db = {
  RequirementType,
  RiskLevel,
  ...
  Relationships,
  parseDirective,
  getConfig: () => (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_7__.g)().req,
  addRequirement,
  getRequirements,
  setNewReqId,
  setNewReqText,
  ...
  setAccTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_8__.s,
  getAccTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_8__.g,
  setAccDescription: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_8__.b,
  getAccDescription: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_8__.a,
  addElement,
  getElements,
  setNewElementType,
  setNewElementDocRef,
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  if (rel.type == diagObj.db.Relationships.CONTAINS) {
    svgPath.attr(
      "marker-start",
      "url(" + _config_5161385b_js__WEBPACK_IMPORTED_MODULE_7__.d.getUrl(conf.arrowMarkerAbsolute) + "#" + rel.type + "_line_ending)"
    );
  } else {
    svgPath.attr("stroke-dasharray", "10,7");
    svgPath.attr(
      "marker-end",
      "url(" + _config_5161385b_js__WEBPACK_IMPORTED_MODULE_7__.d.getUrl(conf.arrowMarkerAbsolute) + "#" + markers.ReqMarkers.ARROW + "_line_ending)"
    );
  }
...
const drawReqs = (reqs, graph, svgNode) => {
  Object.keys(reqs).forEach((reqName) => {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_7__.l.info("Added new requirement: ", reqName);
...
const draw = (text, id, _version, diagObj) => {
  conf = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_7__.g)().requirement;
  diagObj.db.clear();
  ...
  (0,_setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_9__.c)(svg, height, width, conf.useMaxWidth);
...
//# sourceMappingURL=requirementDiagram-61f3cb14.js.map
