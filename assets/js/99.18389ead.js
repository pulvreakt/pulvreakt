...
/* harmony import */ var _setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(33364);
...
const sanitizeText = (text) => (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.b)(text, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.g)());
let nodes = [];
let cnt = 0;
let elements = {};
const clear = () => {
...
const addNode = (level, id, descr, type) => {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.info("addNode", level, id, descr, type);
  const conf = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.g)();
  const node = {
    id: cnt++,
    ...
    type,
    children: [],
    width: (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.g)().mindmap.maxNodeWidth
  };
  switch (node.type) {
...
const getType = (startStr, endStr) => {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("In get type", startStr, endStr);
  switch (startStr) {
    case "[":
...
const getLogger = () => _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l;
...
function drawEdges(edgesEl, cy) {
  cy.edges().map((edge, id) => {
    ...
    if (edge[0]._private.bodyBounds) {
      ...
      _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.trace("Edge: ", id, data);
...
async function layoutMindmap(node, conf) {
  if (!cytoscape) {
    cytoscape = (await __webpack_require__.e(/* import() */ 58).then(__webpack_require__.t.bind(__webpack_require__, 59058, 19))).default;
    const coseBilkent = (await __webpack_require__.e(/* import() */ 607).then(__webpack_require__.t.bind(__webpack_require__, 14607, 19))).default;
  ...
  return new Promise((resolve) => {
    ...
    cy.ready((e) => {
      _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Ready", e);
      resolve(cy);
    });
  });
}
function positionNodes(cy) {
  cy.nodes().map((node, id) => {
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.info("Id:", id, "Position: (", node.position().x, ", ", node.position().y, ")", data);
    el.attr(
      "transform",
...
const draw = async (text, id, version, diagObj) => {
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.l.debug("Renering info diagram\n" + text);
  const securityLevel = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_3__.g)().securityLevel;
  let sandboxElement;
  ...
  positionNodes(cy);
  (0,_setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_4__.s)(void 0, svg, conf.mindmap.padding, conf.mindmap.useMaxWidth);
};
