...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/config-389b86ff.js + 5 modules
var config_389b86ff = __webpack_require__(9419);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/mermaidAPI-0716c7c2.js + 5 modules
var mermaidAPI_0716c7c2 = __webpack_require__(90236);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/commonDb-2ace122b.js
var commonDb_2ace122b = __webpack_require__(40317);
// EXTERNAL MODULE: ./node_modules/dagre-d3-es/src/graphlib/index.js
var graphlib = __webpack_require__(45625);
...
// EXTERNAL MODULE: ./node_modules/mermaid/dist/utils-d5eeff82.js
var utils_d5eeff82 = __webpack_require__(85408);
// EXTERNAL MODULE: ./node_modules/mermaid/dist/setupGraphViewbox-e35e4124.js
var setupGraphViewbox_e35e4124 = __webpack_require__(48003);
...
;// CONCATENATED MODULE: ./node_modules/mermaid/dist/erDiagram-25977acd.js
...
const parseDirective = function(statement, context, type) {
  mermaidAPI_0716c7c2.m.parseDirective(this, statement, context, type);
};
const addEntity = function(name) {
  if (entities[name] === void 0) {
    entities[name] = { attributes: [] };
    config_389b86ff.l.info("Added new entity :", name);
  }
...
const addAttributes = function(entityName, attribs) {
  ...
  for (i = attribs.length - 1; i >= 0; i--) {
    ...
    config_389b86ff.l.debug("Added attribute ", attribs[i].attributeName);
  }
};
const addRelationship = function(entA, rolA, entB, rSpec) {
  ...
  config_389b86ff.l.debug("Added new relationship :", rel);
};
const getRelationships = () => relationships;
const clear = function() {
  entities = {};
  relationships = [];
  (0,commonDb_2ace122b.f)();
};
const erDb = {
  Cardinality,
  Identification,
  parseDirective,
  getConfig: () => (0,config_389b86ff.g)().er,
  addEntity,
  addAttributes,
  getEntities,
  addRelationship,
  getRelationships,
  clear,
  setAccTitle: commonDb_2ace122b.s,
  getAccTitle: commonDb_2ace122b.g,
  setAccDescription: commonDb_2ace122b.b,
  getAccDescription: commonDb_2ace122b.a,
  setDiagramTitle: commonDb_2ace122b.d,
  getDiagramTitle: commonDb_2ace122b.e
};
const ERMarkers = {
...
const drawAttributes = (groupNode, entityTextNode, attributes) => {
  ...
  attributes.forEach((item) => {
    ...
    let nodeHeight = 0;
    const attributeType = (0,config_389b86ff.p)(item.attributeType);
    const typeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-type`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,config_389b86ff.g)().fontFamily).style("font-size", attrFontSize + "px").text(attributeType);
    const nameNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-name`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,config_389b86ff.g)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeName);
    const attributeNode = {};
    ...
    if (hasKeyType) {
      ...
      const keyTypeNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-key`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,config_389b86ff.g)().fontFamily).style("font-size", attrFontSize + "px").text(keyTypeNodeText);
    ...
    if (hasComment) {
      const commentNode = groupNode.append("text").classed("er entityLabel", true).attr("id", `${attrPrefix}-comment`).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "left").style("font-family", (0,config_389b86ff.g)().fontFamily).style("font-size", attrFontSize + "px").text(item.attributeComment || "");
...
const drawEntities = function(svgNode, entities2, graph) {
  ...
  keys.forEach(function(entityName) {
    ...
    const textNode = groupNode.append("text").classed("er entityLabel", true).attr("id", textId).attr("x", 0).attr("y", 0).style("dominant-baseline", "middle").style("text-anchor", "middle").style("font-family", (0,config_389b86ff.g)().fontFamily).style("font-size", conf.fontSize + "px").text(entityName);
...
const drawRelationshipFromLayout = function(svg, rel, g, insert, diagObj) {
  ...
  const labelNode = svg.append("text").classed("er relationshipLabel", true).attr("id", labelId).attr("x", labelPoint.x).attr("y", labelPoint.y).style("text-anchor", "middle").style("dominant-baseline", "middle").style("font-family", (0,config_389b86ff.g)().fontFamily).style("font-size", conf.fontSize + "px").text(rel.roleA);
...
const draw = function(text, id, _version, diagObj) {
  conf = (0,config_389b86ff.g)().er;
  config_389b86ff.l.info("Drawing ER diagram");
  const securityLevel = (0,config_389b86ff.g)().securityLevel;
  let sandboxElement;
  ...
  utils_d5eeff82.u.insertTitle(svg, "entityTitleText", conf.titleTopMargin, diagObj.db.getDiagramTitle());
  const svgBounds = svg.node().getBBox();
  const width = svgBounds.width + padding * 2;
  const height = svgBounds.height + padding * 2;
  (0,setupGraphViewbox_e35e4124.c)(svg, height, width, conf.useMaxWidth);
