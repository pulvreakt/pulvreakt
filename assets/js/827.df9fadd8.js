...
/* harmony export */ });
/* harmony import */ var _mermaidAPI_a1a81019_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(44724);
...
const setC4Type = function(c4TypeParam) {
  let sanitizedText = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.b)(c4TypeParam, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  c4Type = sanitizedText;
};
const parseDirective = function(statement, context, type) {
  _mermaidAPI_a1a81019_js__WEBPACK_IMPORTED_MODULE_5__.m.parseDirective(this, statement, context, type);
};
...
const setTitle = function(txt) {
  let sanitizedText = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.b)(txt, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  title = sanitizedText;
};
const c4Db = {
  addPersonOrSystem,
  ...
  parseDirective,
  getConfig: () => (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)().c4,
  clear,
  LINETYPE,
  ARROWTYPE,
  PLACEMENT,
...
const _drawTextCandidateFunc = function() {
  ...
  function byTspan(content, g, x, y, width, height, textAttrs, conf2) {
    ...
    const lines = content.split(_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.lineBreakRegex);
...
const setConf = function(cnf) {
  (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.c)(conf, cnf);
  if (cnf.fontFamily) {
...
function calcC4ShapeTextWH(textType, c4Shape, c4ShapeTextWrap, textConf, textLimitWidth) {
  if (!c4Shape[textType].width) {
    if (c4ShapeTextWrap) {
      c4Shape[textType].text = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.w)(c4Shape[textType].text, textLimitWidth, textConf);
      c4Shape[textType].textLines = c4Shape[textType].text.split(_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.lineBreakRegex).length;
      c4Shape[textType].width = textLimitWidth;
      c4Shape[textType].height = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.k)(c4Shape[textType].text, textConf);
    } else {
      let lines = c4Shape[textType].text.split(_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.lineBreakRegex);
      ...
      for (const line of lines) {
        c4Shape[textType].width = Math.max(
          (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.j)(line, textConf),
          c4Shape[textType].width
        );
        lineHeight = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.k)(line, textConf);
...
const drawBoundary = function(diagram2, boundary, bounds) {
  ...
  let textLimitWidth = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.j)(boundary.label.text, boundaryLabelConf);
...
const drawC4ShapeArray = function(currentBounds, diagram2, c4ShapeArray2, c4ShapeKeys) {
  ...
  for (const c4ShapeKey of c4ShapeKeys) {
    ...
    c4Shape.typeC4Shape.width = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.j)(
...
const drawRels = function(diagram2, rels2, getC4ShapeObj, diagObj) {
  ...
  for (let rel of rels2) {
    ...
    let textLimitWidth = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.j)(rel.label.text, relConf);
    calcC4ShapeTextWH("label", rel, relTextWrap, relConf, textLimitWidth);
    if (rel.techn && rel.techn.text !== "") {
      textLimitWidth = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.j)(rel.techn.text, relConf);
      calcC4ShapeTextWH("techn", rel, relTextWrap, relConf, textLimitWidth);
    }
    if (rel.descr && rel.descr.text !== "") {
      textLimitWidth = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_7__.j)(rel.descr.text, relConf);
...
const draw = function(_text, id, _version, diagObj) {
  conf = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)().c4;
  const securityLevel = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)().securityLevel;
  let sandboxElement;
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`C:${JSON.stringify(conf, null, 2)}`);
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(`models:`, box);
};
const c4Renderer = {
...
//# sourceMappingURL=c4Diagram-2ae3841a.js.map
