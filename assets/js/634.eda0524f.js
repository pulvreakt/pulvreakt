...
/* harmony import */ var _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(53622);
/* harmony import */ var _mermaidAPI_a1a81019_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(44724);
/* harmony import */ var _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(58553);
...
let mainBranchName = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph.mainBranchName;
let mainBranchOrder = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph.mainBranchOrder;
let commits = {};
let head = null;
let branchesConfig = {};
...
let seq = 0;
function getId() {
  return (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_5__.o)({ length: 7 });
}
const parseDirective = function(statement, context, type) {
  _mermaidAPI_a1a81019_js__WEBPACK_IMPORTED_MODULE_6__.m.parseDirective(this, statement, context, type);
};
...
const setOptions = function(rawOptString) {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("options str", rawOptString);
  rawOptString = rawOptString && rawOptString.trim();
  rawOptString = rawOptString || "{}";
  try {
    options = JSON.parse(rawOptString);
  } catch (e) {
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.error("error while parsing gitGraph options", e.message);
  }
};
...
const commit = function(msg, id, type, tag) {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Entering commit:", msg, id, type, tag);
  id = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(id, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  msg = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(msg, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  tag = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(tag, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  const commit2 = {
    id: id ? id : seq + "-" + getId(),
    message: msg,
    seq: seq++,
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in pushCommit " + commit2.id);
};
const branch = function(name, order) {
  name = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(name, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  if (branches[name] === void 0) {
    branches[name] = head != null ? head.id : null;
    branchesConfig[name] = { name, order: order ? parseInt(order, 10) : null };
    checkout(name);
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in createBranch");
  } else {
    let error = new Error(
...
const merge = function(otherBranch, custom_id, override_type, custom_tag) {
  otherBranch = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(otherBranch, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  custom_id = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(custom_id, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  ...
  commits[commit2.id] = commit2;
  branches[curBranch] = commit2.id;
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(branches);
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in mergeBranch");
};
const cherryPick = function(sourceId, targetId, tag) {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("Entering cherryPick:", sourceId, targetId, tag);
  sourceId = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(sourceId, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  targetId = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(targetId, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  tag = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(tag, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
  ...
  if (!targetId || commits[targetId] === void 0) {
    ...
    branches[curBranch] = commit2.id;
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(branches);
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in cherryPick");
  }
};
const checkout = function(branch2) {
  branch2 = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.d.sanitizeText(branch2, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)());
...
function prettyPrintCommitHistory(commitArr) {
  ...
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(label.join(" "));
...
const prettyPrint = function() {
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(commits);
...
const clear$1 = function() {
  commits = {};
  head = null;
  let mainBranch = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph.mainBranchName;
  let mainBranchOrder2 = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph.mainBranchOrder;
  branches = {};
  ...
  seq = 0;
  (0,_commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_7__.f)();
};
...
const getCommitsArray = function() {
  ...
  commitArr.forEach(function(o) {
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug(o.id);
  });
...
const gitGraphDb = {
  parseDirective,
  getConfig: () => (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.g)().gitGraph,
  setDirection,
  setOptions,
  getOptions,
  commit,
  ...
  getDirection,
  getHead,
  setAccTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_7__.s,
  getAccTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_7__.g,
  getAccDescription: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_7__.a,
  setAccDescription: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_7__.b,
  setDiagramTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_7__.d,
  getDiagramTitle: _commonDb_7528607a_js__WEBPACK_IMPORTED_MODULE_7__.e,
...
const drawCommits = (svg, commits2, modifyGraph) => {
  const gitGraphConfig = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_5__.q)().gitGraph;
...
const draw = function(txt, id, ver, diagObj) {
  clear();
  const conf = (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_5__.q)();
  const gitGraphConfig = conf.gitGraph;
  _config_5161385b_js__WEBPACK_IMPORTED_MODULE_4__.l.debug("in gitgraph renderer", txt + "\n", "id:", id, ver);
  ...
  _utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_5__.u.insertTitle(
    diagram2,
    "gitTitleText",
    gitGraphConfig.titleTopMargin,
    diagObj.db.getDiagramTitle()
  );
  (0,_utils_3cbdbddf_js__WEBPACK_IMPORTED_MODULE_5__.s)(
    void 0,
    diagram2,
