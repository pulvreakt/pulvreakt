...
const addSection = function(id, value) {
  id = _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.d.sanitizeText(id, (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)());
  if (sections[id] === void 0) {
    sections[id] = value;
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Added new section :", id);
  }
};
...
const db = {
  parseDirective,
  getConfig: () => (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)().pie,
  addSection,
  getSections,
  cleanupValue,
  clear,
...
let conf = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)();
let width;
const height = 450;
const draw = (txt, id, _version, diagObj) => {
  try {
    conf = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)();
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Rendering info diagram\n" + txt);
    const securityLevel = (0,_config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.g)().securityLevel;
    let sandboxElement;
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.debug("Parsed info diagram");
    ...
    (0,_setupGraphViewbox_e1099da8_js__WEBPACK_IMPORTED_MODULE_7__.c)(diagram2, height, width, conf.pie.useMaxWidth);
    ...
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.error("Error while rendering info diagram");
    _config_5161385b_js__WEBPACK_IMPORTED_MODULE_5__.l.error(e);
  }
};
const renderer = {
  draw
...
//# sourceMappingURL=pieDiagram-00db3e06.js.map
